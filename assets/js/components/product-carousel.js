const initCarousel = () => {
  ...
  carousels.forEach((carousel) => {
    const prevButton = carousel.parentElement.querySelectorAll('.products__carousel-control--prev');
    const nextButton = carousel.parentElement.querySelectorAll('.products__carousel-control--next');
