    ...
    <div class="action-menu__wrapper">
        <header class="action-menu__header">
            ...
            <ul class="action-menu__actions">
                ...
                <li class="action-menu__item">
                    <button class="icon-container action-menu__button" data-action="user"><?php echo getIcon('user')?></button>
                </li>
                <li class="action-menu__item">
                    <button class="icon-container action-menu__button" data-action="bag"><?php echo getIcon('bag')?></button>
                </li>
            </ul>
        </header>
