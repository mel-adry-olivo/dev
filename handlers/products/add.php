...
$product = createProductArray($brand['brand_id'], $name, $price, $type, $lensWidth, $bridgeWidth, $templeLength, $image1Path, $image2Path);
...
function createProductArray($brandId, $name, $price, $type, $lensWidth, $bridgeWidth, $templeLength, $image1Path, $image2Path) {
    return array(
        "brand_id" => $brandId, 
        "name" => $name, 
        "price" => $price, 
