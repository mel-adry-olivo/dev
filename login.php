                ...
                <div class="auth-login">
                    ...
                    <form action="./handlers/auth/login.php" method="POST" class="auth__form">
                        <div class="auth__field-group">
                            ...
                            <input type="text" id="login-email" class="auth__field" name="login-email" autocomplete="off"/>
                        </div>
                        <div class="auth__field-group">
                            <label for="login-password" class="auth__label">Password</label>
                            <input type="password" id="login-password" class="auth__field" name="login-password" autocomplete="off"/>
                        </div>
                ...
                <div class="auth-register">
                    ...
                    <form action="./handlers/auth/register.php" method="POST" class="auth__form">
                        ...
                        <div class="auth__field-group">
                            ...
                            <input type="text" id="register-email" class="auth__field" name="register-email" autocomplete="off" required>
                        </div>
                        <div class="auth__field-group">
